...
import { createTaskSchema, updateTaskSchema, searchTaskSchema, moveTaskSchema } from "../../validators/task.schema";
...
router.patch("/:id/move", protect, validateRequest(moveTaskSchema), taskController.moveTask);
